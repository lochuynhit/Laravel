...
<head>
    ...
    <meta name="description" content="Project Demo Laravel">
    <meta name="author" content="Huynh Huu Loc">
    ...
    <!-- ckEditor && ckFinder -->
    <script src="{{ url('public/admin/plugin-editor/ckeditor/ckeditor.js') }}"></script>
    <script src="{{ url('public/admin/plugin-editor/ckfinder/ckfinder.js') }}"></script>
    <script type="text/javascript">
        var baseURL= "{!! url('/') !!}"
    </script>
    <script src="{{ url('public/admin/plugin-editor/func_ckfinder.js') }}"></script>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        @if (Session::has('flash_messeger'))
                            <div class="alert alert-{!! Session::get('alert_messeger') !!}">
                                {!! Session::get('flash_messeger') !!}
                            </div>
                        @endif
                    </div>
                    <!-- Page Content -->
